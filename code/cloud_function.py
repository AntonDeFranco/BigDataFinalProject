...
BASE_URL: str = (
    ...
    + f"lat={CHICAGO_LAT}&lon={CHICAGO_LON}"
)
...
def fetch_weather_data(api_key: str = OWM_API_KEY) -> Dict[str, Any]:
    url = BASE_URL + f"&appid={api_key}"
...
def transform_data_for_bigquery(weather_data: Dict[str, Any]) -> Any:
